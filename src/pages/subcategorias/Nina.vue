...
productos.forEach(producto => {
    ...
    if (producto.catalogo === 'Niña' && producto.paletaPrincipal) {
...
const productosFiltrados = computed(() => {
    ...
    const productosNiña = productos.filter(
        producto => producto.catalogo === 'Niña'
    )

    if (filtroActivo.value === 'Todos') {
        return productosNiña
    }

    return productosNiña.filter(
