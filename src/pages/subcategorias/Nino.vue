...
productos.forEach(producto => {
    ...
    if (producto.catalogo === 'Niño' && producto.paletaPrincipal) {
...
const productosFiltrados = computed(() => {
    ...
    const productosNiño = productos.filter(
        producto => producto.catalogo === 'Niño'
    )

    if (filtroActivo.value === 'Todos') {
        return productosNiño
    }

    return productosNiño.filter(
